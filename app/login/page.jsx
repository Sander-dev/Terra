...
export default function Home() {
  return (
    <div className="flex flex-col justify-center items-center bg-farm w-screen h-screen bg-cover bg-current">
      <div></div>

      <div className="flex w-screen justify-end mr-5 items-start">
        <Tabs></Tabs>
      </div>
      <div className="backdrop-blur-sm w-[65vw] sm:w-[55vw] md:w-[45vw] lg:w-[30vw] rounded-md bg-zinc-200 bg-opacity-65 p-6 shadow-slogin dark:bg-neutral-700">
        <div className="flex justify-center text-5xl mb-4">
          <h1>Entrar</h1>
        </div>
        <form>
          {/* <!--E-mail input--> */}
          <TEInput type="email" label="Email address">
            <small
              id="emailHelp2"
